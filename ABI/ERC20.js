  ...
  entry_points_by_type: {
    ...
    EXTERNAL: [
      ...
      },
      {
        offset: "0x594",
        selector:
          "0x1aaf3e6107dd1349c81543ff4221a326814f77dadcc5810807b74f1a49ded4e",
      },
      {
        offset: "0x4d5",
        selector:
  ...
  program: {
    ...
    identifiers: {
      ...
      "__wrappers__.allowance.Return": {
        cairo_type:
          "(syscall_ptr: felt*, pedersen_ptr: starkware.cairo.common.cairo_builtins.HashBuiltin*, range_check_ptr: felt, size: felt, retdata: felt*)",
